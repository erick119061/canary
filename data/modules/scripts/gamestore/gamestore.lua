...
local premiumCategoryName = "Special Items and Equip"
local premiumOfferName = "Special Items and Equip"
		...
		offers = {
			{
				...
				itemtype = 22516,
				count = 100,
				description = "Use 1 token to recieve 10 dust for forge!",
			...
			},
			{
				...
				itemtype = 22721,
				count = 100,
				description = "It can be exchanged with Yana for various weapons and for Creature Products that can be used to imbue them.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 28495,
				count = 1,
				description = "Use this to refill 1 hour of stamina!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 31633,
				count = 1,
				description = "Use this cube to teleport to temple! (Cannot used if PZ'ed!)",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 39546,
				count = 1,
				description = "Use this bag to get a random item from the Primal Set!.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 34109,
				count = 1,
				description = "Use this bag to get a random item from the Soul Set!.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 6510,
				count = 1,
				description = "Use this bag to get a random item from the Cobra Set!.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Falcon_Bag.png" },
				name = "Falcon Bag",
				price = 75,
				itemtype = 6505,
				count = 1,
				description = "Use this bag to get a random item from the Falcon Set!.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 6509,
				count = 1,
				description = "Use this bag to get a random item from the Lion Set!.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Qumora_Boots.png" },
				name = "Qumora Boots",
				price = 420,
				itemtype = 40593,
				count = 1,
				description = "You see a qumora boots (magic level +1, protection death +3%). It can only be wielded properly by players of level 700 or higher. Imbuements: (Empty Slot). It weighs 8.00 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Silver_Moon_Coin.png" },
				name = "5x Silver Moon Coin",
				price = 320,
				itemtype = 43732,
				count = 5,
				description = "Use this coin in the Roulette room, gamble at your own risk!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Silver_Moon_Coin.png" },
				name = "1x Silver Moon Coin",
				price = 75,
				itemtype = 43732,
				count = 1,
				description = "Use this coin in the Roulette room, gamble at your own risk!",
			...
			},
			{
				...
				itemtype = 14758,
				count = 1,
				description = "Use this scroll to recieve +30 Premium Days!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
			...
			},
			{
				...
				itemtype = 19369,
                count = 1,
                description = "(critical hit chance 10%, critical extra damage +30%, protection all +5%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 37611,
                count = 1,
                description = "Use this bag to sell all your loot!",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Tibia_coin.png" },
				name = "Tibia Coin",
                price = 25, 
				itemtype = 22118,
                count = 25,
                description = "(Tibia Coin /deposit Tibia coins, 100).",
