local mType = Game.createMonsterType("Ice Litches")
local monster = {}

monster.description = "an Ice Litches"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_PHYSICALDAMAGE, minDamage = 1700, maxDamage = -3500, range = 7, shootEffect = CONST_ANI_ONYXARROW, target = false}
}
