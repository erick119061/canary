local mType = Game.createMonsterType("Old Hag")
local monster = {}

monster.description = "an Old Hag"
monster.experience = 66100
monster.outfit = {
	lookType = 1417,
	lookHead = 0,
	lookBody = 0,
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 1800, maxDamage = -3640},
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_PHYSICALDAMAGE, minDamage = -2000, maxDamage = -5200, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = true}
}
