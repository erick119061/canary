local mType = Game.createMonsterType("Infernal Hydra")
local monster = {}

monster.description = "a Infernal Hydra"
monster.experience = 68500
monster.outfit = {
	lookType = 563,
	lookHead = 0,
	lookBody = 0,
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 600, maxDamage = -3800, condition = {type = CONDITION_POISON, totalDamage = 160, interval = 4000}},
	{name ="drunk", interval = 2000, chance = 20, range = 7, radius = 4, effect = CONST_ME_SOUND_RED, target = false, duration = 4000},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -1540, maxDamage = -3700, radius = 3, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -1860, maxDamage = -3800, range = 7, shootEffect = CONST_ANI_POISON, target = false}
}

monster.defenses = {
	defense = 0,
	armor = 0,
	{name ="combat", interval = 2000, chance = 5, type = COMBAT_HEALING, minDamage = 70, maxDamage = 1100, effect = CONST_ME_SOUND_WHITE, target = false},
