local mType = Game.createMonsterType("Fire Spooder")
local monster = {}

monster.description = "a Fire Spooder"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -5450},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -5, maxDamage = -3840, range = 7, shootEffect = CONST_ANI_THROWINGKNIFE, target = false}
}
