local mType = Game.createMonsterType("Corrupted Shadow")
local monster = {}

monster.description = "a corrupted shadow"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 50, attack = 150},
	{name ="combat", interval = 100, chance = 22, type = COMBAT_PHYSICALDAMAGE, minDamage = -2000, maxDamage = -9310, radius = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="outfit", interval = 1000, chance = 1, radius = 1, target = true, duration = 20000, outfitMonster = "Werebear"},
	{name ="combat", interval = 100, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -1000, maxDamage = -200, radius = 3, effect = CONST_ME_SOUND_WHITE, target = false}
}

monster.defenses = {
	defense = 30,
	armor = 30,
	{name ="combat", interval = 2000, chance = 7, type = COMBAT_HEALING, minDamage = 1120, maxDamage = 1310, effect = CONST_ME_MAGIC_BLUE, target = false},
