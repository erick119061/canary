local mType = Game.createMonsterType("Corrupted Greed")
local monster = {}

monster.description = "Corrupted Greed"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -25000},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -21500, maxDamage = -2000, range = 7, radius = 5, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_GROUNDSHAKER, target = true},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -21200, maxDamage = -2200, length = 8, spread = 1, effect = CONST_ME_FIREAREA, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -1300, maxDamage = -21700, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
}
