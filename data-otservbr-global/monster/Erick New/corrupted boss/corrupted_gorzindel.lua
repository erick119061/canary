local mType = Game.createMonsterType("Corrupted Gorzindel")
local monster = {}

monster.description = "Corrupted Gorzindel"
...
monster.loot = {
	...
	{name = "gold token", chance = 100000, maxCount = 12},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 100, attack = 500},
	{name ="melee", interval = 2000, chance = 15, minDamage = -1600, maxDamage = -15800},
	{name ="melee", interval = 1000, chance = 15, minDamage = -1800, maxDamage = -15300},
	{name ="melee", interval = 1000, chance = 15, minDamage = -1800, maxDamage = -15000},
	{name ="melee", interval = 1000, chance = 15, minDamage = -1200, maxDamage = -15800},
