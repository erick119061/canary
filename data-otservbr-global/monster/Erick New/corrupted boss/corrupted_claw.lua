local mType = Game.createMonsterType("Corrupted Claw")
local monster = {}

monster.description = "a corrupted claw"
...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = 1000, maxDamage = 7200, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, target = false},
	{name ="speed", interval = 2000, chance = 15, speedChange = -6000, range = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 20000},
	{name ="combat", interval = 1000, chance = 14, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -7000, length = 5, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="outfit", interval = 1000, chance = 1, radius = 1, target = true, duration = 20000, outfitMonster = "Werebadger"},
...
monster.defenses = {
	defense = 45,
	armor = 40,
	{name ="combat", interval = 4000, chance = 15, type = COMBAT_HEALING, minDamage = 4150, maxDamage = 345, effect = CONST_ME_MAGIC_BLUE, target = false},
