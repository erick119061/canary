local mType = Game.createMonsterType("Corrupted Megalomania")
local monster = {}

monster.description = "Corrupted Megalomania"
...
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -38000},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -12950, maxDamage = -34400, range = 7, radius = 3, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -13000, maxDamage = -35500, length = 8, spread = 3, effect = CONST_ME_INSECTS, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -3300, maxDamage = -15500, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -13300, maxDamage = -35200, length = 10, spread = 0, effect = CONST_ME_BLUE_GHOST, target = false},
}
...
monster.defenses = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HEALING, minDamage = 5250, maxDamage = 14250, effect = CONST_ME_MAGIC_BLUE, target = false},
}
