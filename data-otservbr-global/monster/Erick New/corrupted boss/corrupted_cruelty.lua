local mType = Game.createMonsterType("Corrupted Cruelty")
local monster = {}

monster.description = "Corrupted Cruelty"
...
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -50000},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -14000, maxDamage = -18000, length = 8, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -1700, maxDamage = -25000, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -10000, maxDamage = -25000, range = 7, radius = 4, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_DRAWBLOOD, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -15000, maxDamage = -30000, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false}
}
...
monster.defenses = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HEALING, minDamage = 3250, maxDamage = 13250, effect = CONST_ME_MAGIC_BLUE, target = false},
}
