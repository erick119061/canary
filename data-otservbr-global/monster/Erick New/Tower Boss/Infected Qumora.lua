local mType = Game.createMonsterType("Infected Qumora")
local monster = {}

monster.description = "an Infected Qumora"
...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 1110, maxDamage = -15500, length = 8, spread = 0, effect = CONST_ME_GREYCHAIN},
	...
	{name ="combat", interval = 1000, chance = 7, type = COMBAT_MANADRAIN, minDamage = -1100, maxDamage = -31000, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_POFF, target = false},
	...
	{name ="combat", interval = 1000, chance = 13, type = COMBAT_LIFEDRAIN, minDamage = -2400, maxDamage = -34700, radius = 8, effect = CONST_ME_LOSEENERGY, target = false},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -2400, maxDamage = -25700, radius = 8, effect = CONST_ME_MAGIC_GREEN, target = false},
	...
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -3100, maxDamage = -22900, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -3500, maxDamage = -25350, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false}
}

monster.defenses = {
	defense = 160,
	armor = 160,
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_HEALING, minDamage = 5000, maxDamage = 35000, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="combat", interval = 1000, chance = 25, type = COMBAT_HEALING, minDamage = 6000, maxDamage = 13000, effect = CONST_ME_MAGIC_BLUE, target = false},
