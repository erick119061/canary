local mType = Game.createMonsterType("Infected Crawler")
local monster = {}

monster.description = " an Infected Crawler"
...
monster.attacks = {
	{name ="melee", interval = 3000, chance = 100, minDamage = -3500, maxDamage = -6300},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -5700, maxDamage = -9800, length = 12, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -8600, maxDamage = -10300, length = 12, spread = 3, effect = CONST_ME_TELEPORT, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -3900, maxDamage = -15500, length = 6, spread = 2, effect = CONST_ME_FIREAREA, target = false},
...
monster.defenses = {
	defense = 50,
	armor = 50,
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HEALING, minDamage = 4220, maxDamage = 9535, effect = CONST_ME_YELLOW_RINGS, target = false},
