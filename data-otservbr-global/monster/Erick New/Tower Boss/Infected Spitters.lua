local mType = Game.createMonsterType("Infected Spitters")
local monster = {}

monster.description = "an Infected Spitters"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -5190, maxDamage = -8300, range = 7, length = 6, spread = 3, shootEffect = CONST_ANI_POISON, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -1170, maxDamage = -5160, range = 3, length = 6, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -190, maxDamage = -4160, range = 3, length = 6, spread = 3, effect = CONST_ME_HITBYFIRE, target = false},
