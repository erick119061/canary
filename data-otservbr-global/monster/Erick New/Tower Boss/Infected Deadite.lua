local mType = Game.createMonsterType("Infected Deadite")
local monster = {}

monster.description = "an Infected Deadite"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 9000, maxDamage = 36000}
}
