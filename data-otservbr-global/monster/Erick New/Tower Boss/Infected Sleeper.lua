local mType = Game.createMonsterType("Infected Sleeper")
local monster = {}

monster.description = "Infected Sleeper"
...
monster.health = 40000000
monster.maxHealth = 40000000
monster.race = "blood"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -21000},
	{name ="energy beam", interval = 2000, chance = 10, minDamage = -8500, maxDamage = -29200, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="energy wave", interval = 2000, chance = 10, minDamage = -1500, maxDamage = -24200, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false}
}
