...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1810},
	...
	{name ="lavafungus ring", interval = 2000, chance = 20, minDamage = -450, maxDamage = -1610},
