local mType = Game.createMonsterType("Narf")
local monster = {}

monster.description = "a Narf"
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 4530, maxDamage = -9500 },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 1440, maxDamage = -4200, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false },
}
