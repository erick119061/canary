local mType = Game.createMonsterType("Scabaras")
local monster = {}

monster.description = "a Scabaras"
...
monster.health = 12700
monster.maxHealth = 12700
monster.race = "blood"
monster.corpse = 6339
monster.speed = 232
monster.manaCost = 0
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 1110, maxDamage = -3150 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -1120, maxDamage = -5170, range = 7, radius = 1, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_SMALLCLOUDS, target = true },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -2150, maxDamage = -6450, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true },
}
