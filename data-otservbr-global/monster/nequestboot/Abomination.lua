local mType = Game.createMonsterType("Abomination")
local monster = {}

monster.description = "a Abomination"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -2200, maxDamage = -9350, radius = 4, effect = CONST_ME_POISONAREA, target = false },
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -4200, maxDamage = -9530, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_HITBYPOISON, target = true },
}
...
monster.defenses = {
	...
	armor = 30,
	--	mitigation = ???,
	{ name = "combat", interval = 1000, chance = 75, type = COMBAT_HEALING, minDamage = 1505, maxDamage = 8605, effect = CONST_ME_MAGIC_BLUE, target = false },
}
