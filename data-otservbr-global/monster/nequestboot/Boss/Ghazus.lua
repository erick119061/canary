local mType = Game.createMonsterType("Ghazus")
local monster = {}

monster.description = "Ghazus"
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 430, attack = 410 },
	{ name = "combat", interval = 1000, chance = 8, type = COMBAT_DEATHDAMAGE, minDamage = -9800, maxDamage = -41900, radius = 9, effect = CONST_ME_MORTAREA, target = false },
	...
	{ name = "combat", interval = 3000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -5300, maxDamage = -22800, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "combat", interval = 3000, chance = 8, type = COMBAT_MANADRAIN, minDamage = -7600, maxDamage = -33700, radius = 10, effect = CONST_ME_ENERGYAREA, target = false },
	{ name = "combat", interval = 2000, chance = 9, type = COMBAT_ENERGYDAMAGE, minDamage = -5400, maxDamage = -12800, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false },
	-- poison
	{ name = "condition", type = CONDITION_POISON, interval = 5000, chance = 18, minDamage = -6800, maxDamage = -11000, effect = CONST_ME_HITBYPOISON, target = false },
	{ name = "combat", interval = 2000, chance = 6, type = COMBAT_LIFEDRAIN, minDamage = -8600, maxDamage = -31200, radius = 14, effect = CONST_ME_MAGIC_GREEN, target = false },
}
