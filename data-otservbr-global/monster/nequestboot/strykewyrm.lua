local mType = Game.createMonsterType("strykewyrm")
local monster = {}

monster.description = "strykewyrm"
...
monster.defenses = {
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_HEALING, minDamage = 1600, maxDamage = 51090, effect = CONST_ME_HITBYFIRE, target = false },
}
