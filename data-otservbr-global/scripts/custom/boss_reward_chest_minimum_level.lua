local config = {
    ...
    exhaustStorage = 30062, -- Storage of chest
    level = 8, -- Minimum level to open the chest
    capacity = 1000 -- Minimum capacity required to take a reward (Set to heaviest item's weight)
}
